var t,e,n,s,o,i,a,r,c,l,d,u,h,f,g,m,E,p,C,y,O,v,I,_,T=globalThis,N={},A={},w=T.parcelRequire94c2;null==w&&((w=function(t){if(t in N)return N[t].exports;if(t in A){var e=A[t];delete A[t];var n={id:t,exports:{}};return N[t]=n,e.call(n.exports,n,n.exports),n.exports}var s=Error("Cannot find module '"+t+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(t,e){A[t]=e},T.parcelRequire94c2=w),w.register;var R=w("47Mwn"),S=w("6AR8M"),b=w("ilpIi");(t=h||(h={})).STRING="string",t.NUMBER="number",t.INTEGER="integer",t.BOOLEAN="boolean",t.ARRAY="array",t.OBJECT="object",(e=f||(f={})).LANGUAGE_UNSPECIFIED="language_unspecified",e.PYTHON="python",(n=g||(g={})).OUTCOME_UNSPECIFIED="outcome_unspecified",n.OUTCOME_OK="outcome_ok",n.OUTCOME_FAILED="outcome_failed",n.OUTCOME_DEADLINE_EXCEEDED="outcome_deadline_exceeded";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(t){return t.text=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(t.candidates[0]))throw new L(`${q(t)}`,t);return function(t){var e,n,s,o;let i=[];if(null===(n=null===(e=t.candidates)||void 0===e?void 0:e[0].content)||void 0===n?void 0:n.parts)for(let e of null===(o=null===(s=t.candidates)||void 0===s?void 0:s[0].content)||void 0===o?void 0:o.parts)e.text&&i.push(e.text),e.executableCode&&i.push("\n```"+e.executableCode.language+"\n"+e.executableCode.code+"\n```\n"),e.codeExecutionResult&&i.push("\n```\n"+e.codeExecutionResult.output+"\n```\n");return i.length>0?i.join(""):""}(t)}if(t.promptFeedback)throw new L(`Text not available. ${q(t)}`,t);return""},t.functionCall=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(t.candidates[0]))throw new L(`${q(t)}`,t);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),k(t)[0]}if(t.promptFeedback)throw new L(`Function call not available. ${q(t)}`,t)},t.functionCalls=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(t.candidates[0]))throw new L(`${q(t)}`,t);return k(t)}if(t.promptFeedback)throw new L(`Function call not available. ${q(t)}`,t)},t}function k(t){var e,n,s,o;let i=[];if(null===(n=null===(e=t.candidates)||void 0===e?void 0:e[0].content)||void 0===n?void 0:n.parts)for(let e of null===(o=null===(s=t.candidates)||void 0===s?void 0:s[0].content)||void 0===o?void 0:o.parts)e.functionCall&&i.push(e.functionCall);return i.length>0?i:void 0}const K=[y.RECITATION,y.SAFETY,y.LANGUAGE];function Y(t){return!!t.finishReason&&K.includes(t.finishReason)}function q(t){var e,n,s;let o="";if((!t.candidates||0===t.candidates.length)&&t.promptFeedback)o+="Response was blocked",(null===(e=t.promptFeedback)||void 0===e?void 0:e.blockReason)&&(o+=` due to ${t.promptFeedback.blockReason}`),(null===(n=t.promptFeedback)||void 0===n?void 0:n.blockReasonMessage)&&(o+=`: ${t.promptFeedback.blockReasonMessage}`);else if(null===(s=t.candidates)||void 0===s?void 0:s[0]){let e=t.candidates[0];Y(e)&&(o+=`Candidate was blocked due to ${e.finishReason}`,e.finishMessage&&(o+=`: ${e.finishMessage}`))}return o}function J(t){return this instanceof J?(this.v=t,this):new J(t)}"function"==typeof SuppressedError&&SuppressedError;/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tl{constructor(t){this.apiKey=t}getGenerativeModel(t,e){if(!t.model)throw new x("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new tc(this.apiKey,t,e)}getGenerativeModelFromCachedContent(t,e,n){if(!t.name)throw new B("Cached content must contain a `name` field.");if(!t.model)throw new B("Cached content must contain a `model` field.");for(let n of["model","systemInstruction"])if((null==e?void 0:e[n])&&t[n]&&(null==e?void 0:e[n])!==t[n]){if("model"===n&&(e.model.startsWith("models/")?e.model.replace("models/",""):e.model)===(t.model.startsWith("models/")?t.model.replace("models/",""):t.model))continue;throw new B(`Different value for "${n}" specified in modelParams (${e[n]}) and cachedContent (${t[n]})`)}let s=Object.assign(Object.assign({},e),{model:t.model,tools:t.tools,toolConfig:t.toolConfig,systemInstruction:t.systemInstruction,cachedContent:t});return new tc(this.apiKey,s,n)}}(0,R.auth).onAuthStateChanged(async t=>{t&&await t_()});const td=document.getElementById("logoutBtn"),tu=document.getElementById("biometricAuthBtn"),th=document.getElementById("generateQRCodeBtn"),tf=document.getElementById("addTransactionBtn"),tg=document.getElementById("transactionModal"),tm=document.getElementById("transactionForm"),tE=document.getElementById("cancelBtn"),tp=document.getElementById("transactionsList"),tC=document.getElementById("chatbotModal"),ty=document.getElementById("closeChatbot"),tO=document.getElementById("chatInput"),tv=document.getElementById("sendChat"),tI=document.getElementById("chatbotMessages");async function t_(){let t=R.auth.currentUser;if(t)try{let e=await (0,b.getDocs)((0,b.query)((0,b.collection)(R.db,"transactions"),(0,b.where)("userId","==",t.uid))),n=0,s=0;tp.innerHTML=e.empty?"No transactions yet":"",e.forEach(t=>{let e=t.data();"income"===e.type?n+=parseFloat(e.amount):s+=parseFloat(e.amount);let o=document.createElement("div");o.className=`transaction ${e.type}`,o.innerHTML=`${e.description} ${"income"===e.type?"+":"-"}$${parseFloat(e.amount).toFixed(2)}`;let i=document.createElement("button");i.textContent="Delete",i.className="delete-btn",i.addEventListener("click",async()=>{try{await (0,b.deleteDoc)((0,b.doc)(R.db,"transactions",t.id)),tA("Transaction deleted successfully!"),t_()}catch(t){tA("Error deleting transaction: "+t.message,"error")}}),o.appendChild(i),tp.appendChild(o)}),document.getElementById("totalBalance").textContent=`$${(n-s).toFixed(2)}`,document.getElementById("totalIncome").textContent=`$${n.toFixed(2)}`,document.getElementById("totalExpenses").textContent=`$${s.toFixed(2)}`}catch(t){tA("Error loading transactions: "+t.message,"error")}}async function tT(t){try{let e=new tl("YOUR_API_KEY").getGenerativeModel({model:"gemini-1.5-flash"});return(await e.generateContent(t)).response.text()}catch(t){return"Error: Unable to process your request."}}function tN(t,e){let n=document.createElement("div");n.className="chat-message",n.innerHTML=`${t}: ${e}`,tI.appendChild(n),tI.scrollTop=tI.scrollHeight}function tA(t,e="success"){let n=document.createElement("div");n.className=`toast ${e}`,n.textContent=t,document.getElementById("toastContainer").appendChild(n),setTimeout(()=>n.remove(),3e3)}td.addEventListener("click",()=>{(0,S.signOut)(R.auth).then(()=>{console.log("Signed out successfully!"),window.location.href="index.html"}).catch(t=>{console.error("Error signing out:",t.message)})}),th.addEventListener("click",function(){let t=document.getElementById("qrcode");t.innerHTML="",new QRCode(t,{text:"https://whitemouse25.github.io/budget-web-app/",width:128,height:128}),t.style.display="block"}),tf.addEventListener("click",()=>{tg.classList.add("active")}),tE.addEventListener("click",()=>{tg.classList.remove("active"),tm.reset()}),tm.addEventListener("submit",async t=>{t.preventDefault();let e=t.target.description.value,n=parseFloat(t.target.amount.value),s=t.target.type.value,o=R.auth.currentUser;if(!(!o||!e||isNaN(n))&&s)try{await (0,b.addDoc)((0,b.collection)(R.db,"transactions"),{description:e,amount:n,type:s,userId:o.uid,createdAt:new Date}),tA("Transaction added successfully!"),t_(),tg.classList.remove("active"),tm.reset()}catch(t){tA("Error adding transaction: "+t.message,"error")}}),document.getElementById("chatbotButton").addEventListener("click",()=>{tC.classList.toggle("hidden")}),ty.addEventListener("click",()=>{tC.classList.add("hidden")}),tv.addEventListener("click",async()=>{let t=tO.value.trim();if(t){tN("You",t),tO.value="";try{let e=await tT(t);tN("Gemini AI",e)}catch(t){tA("Error processing chat request: "+t.message,"error")}}}),tu.addEventListener("click",async()=>{if(!window.PublicKeyCredential){alert("WebAuthn not supported in this browser.");return}try{let t=new Uint8Array(32);window.crypto.getRandomValues(t),await navigator.credentials.get({publicKey:{challenge:t,allowCredentials:[],userVerification:"required"}})?alert("Biometric Authentication Successful!"):alert("Authentication Failed!")}catch(t){alert("Biometric Authentication Failed!")}});
//# sourceMappingURL=transactions.8a822fc4.js.map
